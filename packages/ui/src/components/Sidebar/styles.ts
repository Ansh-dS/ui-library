  ...
  ],
  {
    variants: {
      ...
      variant: {
        ...
        inset: 'bg-surface-base border border-border-default rounded-large m-s h-[calc(100%-var(--spacing-m))]',
        
        // Riverside's 15/12/20 Glass Rule for media environments.
        glass: 'bg-surface-base/15 backdrop-blur-md border-r border-border-default/20',
      },
