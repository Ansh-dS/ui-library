...
export const socialButtonVariants = cva(
  ...
  ],
  {
    variants: {
      provider: {
        google: 'bg-surface-base text-fg-primary border-border-default hover:bg-surface-sunken',

        // GitHub adapts to the theme naturally
        github: 'bg-neutral-900 text-fg-inverted border-transparent hover:bg-neutral-800 dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-200',

        apple: 'bg-fg-primary text-fg-inverted border-transparent hover:opacity-90 dark:bg-neutral-100 dark:text-neutral-900',

        generic: 'bg-surface-base text-fg-primary border-border-default hover:border-border-focused',
